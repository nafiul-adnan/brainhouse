...
const Index = () => {
  ...
  const categoryServices = {
    ...
    "interview-prep": [
      ...
      {
        id: "leetcode-problem-training",
        title: "Leetcode problem training - $100/session",
        description: "Focused training on Leetcode problems with expert guidance",
        icon: <BookOpen className="w-8 h-8" />,
        features: ["Problem-solving strategies", "Data structures and algorithms", "Mock problem-solving sessions", "Feedback and improvement"]
      }
    ],
    "career-coaching": [
      {
